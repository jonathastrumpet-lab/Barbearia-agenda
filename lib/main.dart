...
class _HomePageState extends State<HomePage>{
  ...
  @override Widget build(BuildContext context){
    ...
    final actions=<Widget>[
      ...
      _HomeActionCard(icon:Icons.event_available_rounded,title:admin?'Agenda do estabelecimento':'Meus agendamentos',subtitle:admin?'Veja os próximos horários':'Veja e cancele seus próximos horários',onTap:()=>_open(context,const AppointmentsPage())),
      ...
      if(admin)_HomeActionCard(icon:Icons.groups_2_rounded,title:'Profissionais',subtitle:'Cadastre e gerencie profissionais',onTap:()=>_open(context,const TeamPage())),
