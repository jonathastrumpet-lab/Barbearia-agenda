...
class _ScheduleSettingsPageState extends State<ScheduleSettingsPage> {
  ...
  String _time(int? minutes) {if(minutes==null)return '--:--';final hour=(minutes~/60).toString().padLeft(2,'0');final minute=(minutes%60).toString().padLeft(2,'0');return '$hour:$minute';}
